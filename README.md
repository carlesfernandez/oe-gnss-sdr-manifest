...
5.  Build an image.
    ...
    *work/deploy* directory.  If you run into problems, the most likely
    candidate is missing packages.  Check out the [list of required packages for each operating system](http://www.yoctoproject.org/docs/2.0/ref-manual/ref-manual.html#required-packages-for-the-host-development-system).
...
repositories and branches or pull in additional meta-layers. Check out the [OpenEmbedded Layer Index](http://layers.openembedded.org/layerindex/branch/jethro/layers/).
