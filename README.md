...
> The Geniux Dunfell manifest reached its End-of-Life in April 2025.
> Version `dunfell-25.04` is the final release, and no further maintenance is
...
Install it by running:
        ...
        $ sudo sh ./tmp-glibc/deploy/sdk/geniux-x86_64-gnss-sdr-dev-image-zedboard-zynq7-toolchain-dunfell-21.02.1.sh
...
As well, executing
`./tmp-glibc/deploy/sdk/geniux-x86_64-gnss-sdr-demo-image-zedboard-zynq7-toolchain-dunfell-21.02.1.sh`
